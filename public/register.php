...
<body style="text-align:center">
    ...
    <?php else: ?>
       ...
       <form method="POST" style="display:inline-block; text-align:left; margin-top:2rem;">
            <label>Όνομα: <input type="text" name="first_name" required></label><br><br>
            <label>Επώνυμο: <input type="text" name="last_name" required></label><br><br>
            <label>Username: <input type="text" name="username" required></label><br><br>
            <label>Email: <input type="email" name="email" required></label><br><br>
            <label>Κωδικός: <input type="password" name="password" required></label><br><br>
